...
-   By using `position = "fill"` and `y = after_stat(count)` we graph the conditional probability of a decade given that a player has hit a certain number of home runs.
